...
<button type="button" class="btn btn-outline-secondary">
  <a href="showallchild.php">Child List</a></button>
  ...
  <div class="container">
	<div class="reg-form">
	  <div class="container">
	  	...
	  	<form action="phpaction/childupdate.php" method="POST">
          <div class="form-group">

          	 	<input type="text" style="display: none;" value="<?php echo $row["id_child"]; ?> " name="id_child" >
